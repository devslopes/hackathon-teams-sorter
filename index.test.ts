...
describe("createGroups", () => {
  ...
  it("should create groups of specified size", () => {
    const groupSize = 2;
  ...
  it("should create groups with default size of 4", () => {
  ...
  it("should handle case with no students", () => {
    const groups = createGroups([]);
    expect(groups).toEqual([]);
  });

  it("should handle case with group size larger than number of students", () => {
    const groupSize = 10;
    const groups = createGroups(students, groupSize);
  ...
  it("should group students by technical skill level", () => {
  ...
  it("should group students with maximum overlap", () => {
    const groups = createGroups(students, 2);
    groups.forEach((group) => {
      if (group.length > 1) {
